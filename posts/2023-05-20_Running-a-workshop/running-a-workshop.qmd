...
A few weeks ago, I organized and ran a workshop on Git and GitHub for the Center for Infectious Disease Dynamics at the Pennsylvania State University.
...
I put together a companion book for the workshop, which you can find at [https://psu-git.callumarnold.com](https://psu-git.callumarnold.com), and if you find them useful, or especially if you have suggestions, I would love to hear from you!
...
Most workshops I've attended have done a decent job at explaining the material, but my experience with materials that accompany Git workshops is that they tend to be a little too basic, and focus a lot on specific commands within toy examples, so it becomes hard to translate the teachings to problems that you might encounter in your own work.
...
And despite thinking that Git gets a bad rap for being hard to learn, I underestimated how much time it would take to cover the material, which is invariably more technical than some participants were used to.
...
To address this, in the future I will try to split the workshop into two: one introductory workshop for those with effectively no experience, and one more advanced workshop that can address collaboration workflows, and do a better job of explaining the difference between the two when advertising them.
...
This resulted in an awkward balancing act at the beginning of the workshop, as I tried to help some get set up, while also trying to get through the material.
I could have pushed on and left them behind, but I think that would have been a mistake, and would have made the workshop less accessible.
...
I tried to include some exercises throughout the workshop, and had the participants work through the material, setting up a repository, making commits, and pushing to GitHub, but I think setting aside some dedicated time for exercises would have been better.
...
This would allow us to get less derailed by complexity and focus more time on grappling with the material through exercises, before working through them as a group.
